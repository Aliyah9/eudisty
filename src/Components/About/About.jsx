    ...
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>
                ...
                meaninigful impact in classrooms, schools, and communities.
            </p>
            <p>whether you aspire to become a teacher,administrator,
                counselor, or educational leader, our diverse range of programs offers the perfect pathway to achieve your goals and
